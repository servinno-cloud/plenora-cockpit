...
type Snapshot={overall_state:string;component_states:Record<string,string>;service_states:Record<string,string>;data_mode:"live"|"fixture";observed_at:string|null;observations:Observation[];collector:{identity_statuses:CollectorFreshness[]}};
